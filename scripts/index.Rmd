...
- [goals and objectives](pages/01_intro_01_goals.html)
- [pre-workshop homework](pages/01_intro_02_pre-hw.html) 
- [agenda](pages/01_intro_03_agenda.html) 
- surveying the reproducible research ecosystem 
- considering a sample report 

### tutorial 

- [reshape wide data to long](pages/02_tutor_03_tidy-data.html)
