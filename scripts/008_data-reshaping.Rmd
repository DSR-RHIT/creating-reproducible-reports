...
- This output tells me that columns `r is_a_cycle_col` have "cycle" in their columns names. 
- `is_a_cycle_col` is a vector of integers. The number in brackets in the output `## [1]` is the index of the first element, `r is_a_cycle_col[1]`, printed in the row of output. 
...
- *select()* keeps column numbers `r is_a_cycle_col`
