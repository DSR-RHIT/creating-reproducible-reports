...
We see from this initial exploration that the data consist of `r dim(wide_data)[1]` measurements per cycle with `r length(grep('cycle', names(wide_data)))` cycles. 
