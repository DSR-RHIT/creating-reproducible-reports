...
Note that `results_list` is a list of data frames. Each item in the list (`r results_list[[1]]$item`, `r results_list[[2]]$item`, etc) is a  data frame containing one row from the original data frame with columns: `item` (a string), `num` (a number), and `unit` (another string).
