...
# http://citationstyles.org/styles/ for CSL files
library(knitr)
...
$$
The accuracy of the precision weights, 0.1%, is less than one tenth the load cell accuracy, thereby meeting the requirements of the ANSI/ISA standard.[@gandrud2015]
